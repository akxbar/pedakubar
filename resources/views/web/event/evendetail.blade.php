...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-title page-title-small dropdown ">
            ...
            <a href="#" data-menu="#" class="bg-fade-highlight-light shadow-xl preload-img dropdown-toggle"
        ...
        <div class="card card-style">
            <img data-src="{{ asset('storage/' . $event->image) ?? asset('frontend' . '/images/pictures/pedashow.png')  }}"
                                ...
                                <td class="text-center">
                                    <div class="btn-group mb-2 gap-1" role="group" aria-label="Basic mixed styles example">
                                        <button class="btn btn-xxs btn-warning"
                                            onclick="location.href='{{ asset('storage/' . $value['file']) }}'">
