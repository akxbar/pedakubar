                    ...
                    <div class="card card-style"
                        ...
                        <div class="card-bottom">
                            ...
                            <p class="boxed-text-xl">
                                Azures brings beauty and colors to your Mobile device with a stunning user interface to
                                match.
                            </p>
                        </div>
                        <div class="card-overlay bg-gradient-fade"></div>
    ...
    <div class="row mb-0">
        <div class="col-6 pe-0">
            <div class="card card-style me-2">
                <a data-card-height="150" class="card preload-img mb-3"
                    data-src="{{ asset('frontend') }}/images/pictures/25.jpg" href="#">
                ...
                <div class="content mt-0">
                    <p>
                        A small description about your project goes here. Then, you can access the portfolio project to
                        see it in detail.
                    </p>
        ...
        <div class="col-6 ps-0">
            <div class="card card-style ms-2">
                <a data-card-height="150" class="card preload-img mb-3"
                    data-src="{{ asset('frontend') }}/images/pictures/26.jpg" href="#">
                    <div class="card-bottom ms-3 mb-2">
        ...
        <div class="col-6 pe-0">
            <div class="card card-style me-2">
                <a data-card-height="150" class="card preload-img mb-3"
                    data-src="{{ asset('frontend') }}/images/pictures/28.jpg" href="#">
                    <div class="card-bottom ms-3 mb-2">
        ...
        <div class="col-6 ps-0">
            <div class="card card-style ms-2">
                <a data-card-height="150" class="card preload-img mb-3"
                    data-src="{{ asset('frontend') }}/images/pictures/24.jpg" href="#">
                    <div class="card-bottom ms-3 mb-2">
                ...
                <div class="content mt-0">
                    ...
                    <a href="https://youtu.be/NuxBxy0iDoc?si=wf8J1BCLqjXgou3t"
                        class="btn btn-m btn-full bg-highlight font-900 text-uppercase rounded-s">Read More</a>
                </div>
            </div>
        </div>
    ...
    <div class="card card-style">
        <div class="content mb-0">
            ...
            <a href="{{ route('berita') }}">
                <div class="d-flex mb-3">
                    <div class="align-self-center">
                        <h5 class="font-500 font-20 pb-1">What's the next best gadget to come from Apple in <span
                                class="copyright-year"></span>?</h5>
            ...
            <a href="{{ route('berita') }}">
                <div class="d-flex mb-3">
                    <div class="align-self-center">
                        <h5 class="font-500 font-20 pb-1">Laptops are still outselling Mobile Devices? Well, think
                            again!</h5>
        ...
        <div class="row mb-0 p-4 ">
            <div class="col-6 pe-0">
                <div class="card card-style me-2" data-card-height="380"
                    style="background-image:url({{ asset('frontend') }}/images/food/7.jpg)">
