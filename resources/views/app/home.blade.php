...
<link rel="stylesheet" class="page-highlight" type="text/css" href="{{ asset('frontend') }}/styles/highlights/highlight_green.css">
...
<div id="page">
    ...
    <div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l"
        ...
        <div class="boxed-text-l mt-4">
            <img class="rounded-l mb-3" src="{{ asset('frontend') }}/app/icons/icon-128x128.png" alt="img" width="90">
            <h4 class="mt-3">sipedakubar on your Home Screen</h4>
            <p>
                Install sipedakubar on your home screen, and access it just like a regular app. It really is that simple!
            </p>
